...
export default function Tersesat() {
        ...
        return (
                <div className="flex flex-col gap-2 items-center justify-center h-[100vh]">
                        ...
                        <button onClick={() => navigate("/user/beranda")} type="button" class="mt-4 focus:outline-none hover:text-white text-black bg-green-450 hover:bg-green-500 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
