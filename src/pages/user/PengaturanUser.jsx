        ...
        return (
                <section className="p-4 overflow-y-auto">
                        <div className="brand flex items-center gap-2">
                                <svg className="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 40 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span className="text-base sm:text-xl font-normal">Pengaturan</span>
                        </div>

                        <div className="container-settings mt-5">
                                <div className="grid gap-4 px-0 sm:px-12 lg:px-40 py-3 sm:py-10 grid-cols-1">
