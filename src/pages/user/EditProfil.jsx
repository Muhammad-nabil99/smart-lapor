...
export default function EditProfil() {
        ...
        return (
                <section className="p-4">
                        <div className="brand flex items-center gap-2 mb-3">
                                <svg className="w-6 h-6" viewBox="0 0 43 43" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span className="text-xl font-normal">Profil</span>
                        </div>
                        ...
                        <div className="flex flex-col items-center gap-7">
                                ...
                                <div className="grid gap-3 grid-cols-1 sm:grid-cols-2 w-full px-0 sm:px-4 md:px-27">
                                        <div>
                                                <div className="mb-3">
                                ...
                                <div className="buttons flex w-full gap-3 justify-start px-0 sm:px-4 md:px-27">
