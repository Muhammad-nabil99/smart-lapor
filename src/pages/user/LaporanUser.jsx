...
export default function Laporan() {
        ...
        const [visibleDropdownBuatan, setVisibleDropdownBuatan] = useState(false);
        return (
                <section className="p-4">
                        ...
                        <div className="conainer-card grid grid-cols-1 sm:grid-cols-2 gap-5 mt-10">
                                ...
                                <div className="card p-4 shadow-md/30 rounded-md">
                                        ...
                                        <div className="card-body mt-3">
                                                <div className="flex gap-3 flex-col lg:flex-row">
                                                        <div className="w-full h-50 lg:h-auto">
                                                                <img src={gambarKebakaran} className="w-full h-full object-cover rounded" alt="gambar kebakaran" />
                                                        ...
                                                        <div className="mt-4 lg:mt-0">
                                                                <span className="lg:text-2xl text-xl font-extrabold">Kebakaran</span>
                                                                <p className="sm:text-sm lg:text-base text-xs">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has.</p>
                                        ...
                                        <div className="card-footer mt-3">
                                                ...
                                                <div className="hidden sm:flex gap-2 items-center justify-end font-bold">
                                                        <button className="text-[.7rem] py-[8px] shadow-md/30 bg-[#4175D7] text-white rounded-xl px-3 flex items-center gap-1 boder border-[#2B60C1] outline-none">
                                                                <svg className="w-3 h-3" viewBox="0 0 11 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <path className="fill-white" d="M5.5 0.0313187L10.25 4.06299L9.14167 5.00371L6.29167 2.58471V8.7666H4.70833V2.58471L1.85833 5.00371L0.75 4.06299L5.5 0.0313187Z"/>
                                                                </svg>     
