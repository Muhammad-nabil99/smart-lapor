        ...
        return (
                <Navbar fluid className="p-4 w-full sticky top-0 z-20 dark:bg-gray-800">
                        <div className="flex items-center gap-2">
                                ...
                                >
                                        <svg className="w-7 h-7 mb-2" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <NavbarBrand>
                                        <svg className="w-37 h-8" viewBox="0 0 188 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex items-center gap-2">
                                <Button color="transparent" className="flex items-center bg-gray-900 text-gray-50 dark:text-black dark:hover:bg-gray-100 hover:bg-gray-700 dark:bg-white gap-1 h-9 px-3 text-xs sm:px-5 sm:h-10" onClick={() => navigate("/user/buat-laporan")}>
                                ...
                                <span
                                        ...
                                        className="
                                                ...
                                                cursor-pointer h-9 w-9 flex text-white
                                                items-center justify-center rounded-[50%]
                                ">
                                        <i className={`${darkThemeUser ? "fas fa-moon" : "fas fa-sun"}`}></i>
                                </span>
                        </div>
                </Navbar>
        );
