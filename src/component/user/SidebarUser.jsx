...
export default function SidebarUser({ isOpen }) {
        ...
        // ini fungsi buat hilangin backround tombol menu ketika di hover
        useEffect(() => {
                const parent = document.getElementById("sidebar-user");
                const child = document.querySelectorAll('#sidebar-user div[data-testid="flowbite-sidebar-items"] li a:hover');
        ...
        return (
                <Sidebar
                        ...
                        className={`h-[100vh] ${isOpen ? "w-50 sm:w-41" : "w-15  sm:w-25"} border border-gray-100 dark:border-gray-700 sticky top-0 transition-[width] duration-300`}
                >
                        <SidebarItems>
                                <SidebarItemGroup>
                                        <div>
                                                <SidebarItem href="#" id="top-item">
                                                        <div className="flex items-center gap-1 group">
                                                                <button type="button" className="rounded-[50%] bg-[#E9E9E9] p-3 hover:!bg-[#E9E9E9]">
                                                                        <svg className="w-[.9rem] h-[.9rem] sm:w-5 sm:h-5" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                <path d="M15.9993 15.9998C13.891 15.9998 12.0862 15.2491 10.5848 13.7478C9.08338 12.2464 8.33268 10.4415 8.33268 8.33317C8.33268 6.22484 9.08338 4.41998 10.5848 2.91859C12.0862 1.4172 13.891 0.666504 15.9993 0.666504C18.1077 0.666504 19.9125 1.4172 21.4139 2.91859C22.9153 4.41998 23.666 6.22484 23.666 8.33317C23.666 10.4415 22.9153 12.2464 21.4139 13.7478C19.9125 15.2491 18.1077 15.9998 15.9993 15.9998ZM0.666016 31.3332V25.9665C0.666016 24.8804 0.945849 23.8824 1.50552 22.9727C2.06518 22.0629 2.80757 21.3678 3.73268 20.8873C5.71324 19.8971 7.72574 19.1547 9.77018 18.6602C11.8146 18.1657 13.891 17.9178 15.9993 17.9165C18.1077 17.9152 20.1841 18.1631 22.2285 18.6602C24.273 19.1572 26.2855 19.8996 28.266 20.8873C29.1924 21.3665 29.9354 22.0616 30.4951 22.9727C31.0548 23.8837 31.334 24.8817 31.3327 25.9665V31.3332H0.666016Z" className="fill-[#1a1a1a]"/>
                                                                        </svg>
                                                                </button>
                                                                <button className={
                                                                        `${isOpen ? "w-20" : "w-0"}
                                                                        underline underline-offset-3
                                                                        text-[.8rem] transition-[width] duration-300 line-clamp-1`
                                                                }>
                                                                        John Doe
                                                                </button>
                                                        </div>
