...
export default function SidebarIntansi({ darkThemeInstansi }) {
    ...
    return (
        <Sidebar
            ...
            className={`h-[100vh] ${isOpen ? "w-50" : "w-18"} border border-gray-100 dark:border-gray-700 sticky top-0 transition-all duration-100`}
        >
            <SidebarItems className="h-full grid grid-cols-1">
                <SidebarItemGroup>
                    <div className="flex items-center justify-start">
                        <button className="border-none focus:shadow-none outline-none bg-none px-1.5" onClick={() => handleOpenSidebarUser()}>
                            <svg className="w-6 h-6" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    ...
                                    fill={`${darkThemeInstansi ? "white" : "black"}`}
                                />
                            </svg>
                        </button>
                    </div>
                    ...
                    <div className="mt-20 flex flex-col gap-5 items-center">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            >
                                <svg width="20" height="20" viewBox="0 0 31 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button className={`line-clamp-1 flex justify-start dark:text-white ${isOpen ? "w-25" : "w-0"}`}>Riwayat</button>
                        </div>
                    </div>
                </SidebarItemGroup>
                <SidebarItemGroup className="flex border-t-0 items-end justify-center">
                    <div className="flex items-center gap-1">
                        ...
                        <button className={`line-clamp-1 flex justify-start dark:text-white ${isOpen ? "w-25" : "w-0"} text-red-500`}>Logout</button>
                    </div>
                </SidebarItemGroup>
            </SidebarItems>
        </Sidebar>
