...
export default function SidebarInstansi({ isOpen }) {
    return (
            <Sidebar
                    id="sidebar-user"
                    aria-label="Default sidebar example"
                    className={`h-[100vh] w-18 ${
                            isOpen ? "ms-0" : "-ms-25"
                            ...
                            <SidebarItemGroup>
                                    <div>
                                            ...
                                            >
                                                    <button
                                                            type="button"
                                                            className="rounded-[50%] w-10 h-10 flex justify-center items-center  bg-[#E9E9E9] p-3 hover:!bg-[#E9E9E9]"
                                                    >
                                                            <svg
                                                                    width="20"
                                                                    height="20"
